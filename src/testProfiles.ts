...
export const TEST_EMPLOYEES: Employee[] = [
  {
    id: 'test-admin', name: 'Administrateur Test', nip: '', role: 'admin', hourlyRate: 52,
  ...
  {
    id: 'test-secretary', name: 'Sophie Bureau', nip: '', role: 'secretary', hourlyRate: 30,
  ...
  {
    id: 'test-accountant', name: 'Marc Comptable', nip: '', role: 'accountant', hourlyRate: 42,
  ...
  {
    id: 'test-employee-1', name: 'Liam Tremblay', nip: '', role: 'employee', hourlyRate: 34,
  ...
  {
    id: 'test-employee-2', name: 'Emma Roy', nip: '', role: 'employee', hourlyRate: 31,
  ...
  {
    id: 'test-employee-3', name: 'Noah Gagnon', nip: '', role: 'employee', hourlyRate: 38,
  ...
  {
    id: 'test-employee-4', name: 'Olivia Martin', nip: '', role: 'employee', hourlyRate: 36,
  ...
  {
    id: 'test-contractor-1', name: 'Éric Cladding', nip: '', role: 'employee', hourlyRate: 0,
  ...
  {
    id: 'test-contractor-2', name: 'Nadia Exteriors', nip: '', role: 'employee', hourlyRate: 0,
  ...
  {
    id: 'test-contractor-3', name: 'Samuel Roofing', nip: '', role: 'employee', hourlyRate: 0,
  ...
  {
    id: 'test-former-1', name: 'Julien Mercier', nip: '', role: 'employee', hourlyRate: 32,
  ...
  {
    id: 'test-former-2', name: 'Karine Pelletier', nip: '', role: 'employee', hourlyRate: 33,
