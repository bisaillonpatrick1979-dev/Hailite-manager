...
import { canEmployeePunchProject, projectsAvailableForPunch } from '../src/projectAccess.ts';
...
test('la création manuelle transmet réellement les travailleurs choisis', async () => {
  ...
  assert.match(app, /assignedEmployees:\s*\[\.\.\.newProjectForm\.assignedEmployees\]/);
